# Operator Quickstart — Maintenance and repair of motor vehicles

Shortest path from clone to a verified local dry-run for **ISIC 4520** (`cloud-itonami-isic-4520`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4520.git
...
- Blueprint governor key: `autorepair-governor`
- Likely source path: `autorepair.governor.cljc`
